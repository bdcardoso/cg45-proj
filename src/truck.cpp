...
constexpr auto BODY_COLOR_RED =             196,
               BODY_COLOR_GREEN =           8,
               BODY_COLOR_BLUE =            49,
               BACK_COLOR_RED =             130,
               BACK_COLOR_GREEN =           108,
               BACK_COLOR_BLUE =            113,
               CONTAINER_COLOR_RED =        148,
               CONTAINER_COLOR_GREEN =      87,
               CONTAINER_COLOR_BLUE =       100,
...
constexpr auto BODY_SIZE_X =          2.0f,
               BODY_SIZE_Y =          2.0f,
               BODY_SIZE_Z =          3.0f,
               BODY_COORD_X =         3.0f,
               BODY_COORD_Y =         2.7f, //0.01 margin
               BODY_COORD_Z =         0.0f,
               ...
               CONTAINER_SIZE_Y =     2.5f,
               CONTAINER_SIZE_Z =     3.0f,
               CONTAINER_COORD_X =    -1.5f,
               CONTAINER_COORD_Y =    3.0f,
...
void truck::draw() {
   ...
   //Back-Left Wheel2
    glPushMatrix();    
        glTranslatef(WHEEL_COORD_BACK_LEFT2_X, WHEEL_COORD_BACK_LEFT2_Y, WHEEL_COORD_BACK_LEFT2_Z);
        glutSolidTorus(WHEEL_SIZE_INNER_RADIUS, WHEEL_SIZE_OUTER_RADIUS, WHEEL_SIZE_N_SIDES, WHEEL_SIZE_RINGS);
    glPopMatrix();

    //Back-Right Wheel2
    glPushMatrix();    
        glTranslatef(WHEEL_COORD_BACK_RIGHT2_X, WHEEL_COORD_BACK_RIGHT2_Y, WHEEL_COORD_BACK_RIGHT2_Z);
        glutSolidTorus(WHEEL_SIZE_INNER_RADIUS, WHEEL_SIZE_OUTER_RADIUS, WHEEL_SIZE_N_SIDES, WHEEL_SIZE_RINGS);
    glPopMatrix();
}
