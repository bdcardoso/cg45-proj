...
constexpr auto BODY_SIZE_X = 3.0f, BODY_SIZE_Y = 1.0f, BODY_SIZE_Z = 3.0f,
               HEAD_SIZE_X = -1.0f, HEAD_SIZE_Y = -0.5f, HEAD_SIZE_Z = 1.0f,
               TAIL_SIZE_X = -0.5f, TAIL_SIZE_Y = -0.5f, TAIL_SIZE_Z = -0.5f,
               LEG_SIZE_X = 1.0f, LEG_SIZE_Y = 0.5f, LEG_SIZE_Z = 1.0f,
